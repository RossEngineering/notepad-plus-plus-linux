...
| --- | --- | --- | --- | --- | --- |
| RC2-B01 | P0 | LSP UX wiring | RC2 roadmap + RC1 defer (`RC1-B04`) | Open | Diagnostics, hover, and go-to-definition baseline are user-accessible and regression-tested through the Linux UI path. |
