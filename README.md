...
| ------------------------- | ------------------------------------------------------------------------------------------ | --------------- | ------------------------------------------------------------------------ |
| Foundation (Phases `0-8`) | Baseline, architecture, build, platform abstraction, Linux UI, packaging, quality, docs    | Complete        | [`docs/todo-archive-phases-0-8.md`](docs/todo-archive-phases-0-8.md)     |
| Beta 1 (`v0.8.0-beta.1`)  | Phase `9`: language detection + syntax-highlighting quality gates                          | Complete        | [`docs/releases/v0.8.0-beta.1.md`](docs/releases/v0.8.0-beta.1.md)       |
